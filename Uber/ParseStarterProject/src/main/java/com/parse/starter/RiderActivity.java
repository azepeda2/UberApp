        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if (e == null && objects.size() > 0) {
                                        ...
                                        if (distanceInMiles < 0.01) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    requestUberButton.setText("Request Pickup");
                                                    requestActive = false;
                                                    driverActive = false;
                                                }
                                            }, 5000);
                                            ...
                                            markers.add(mMap.addMarker(new MarkerOptions().position(requestLocationLatLng).title("Request Location")
                    ...
                    Log.i("Rider Request", "No Driver Location Yet");
                }
            }
        });
    }
                ...
                if (lastKnownLocation != null) {
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                requestUberButton.setText("Cancel Ride");
                                requestActive = true;

                                checkForUpdates();
                            } else {
                                Log.i("Request Info", "Parse failed uploading user location.");
                            }
                        }
                    });
                } else {
