    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.i("Item click", position + " item was clicked");
                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(ViewRequestsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (requestLatitudes.size() > position && requestLongitudes.size() > position &&
                            lastKnownLocation != null && requestUsernames.size() > position) {
                        ...
                        Log.i("Item click", "requestArrays not greater than position");
                    }
                } else {
                    Log.i("Item click", "Permission denied for driver");
                    ActivityCompat.requestPermissions(ViewRequestsActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                }
            }
        });
